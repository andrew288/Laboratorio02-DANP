...
@Composable
fun CreateAsistente(navController: NavHostController, listaAsistentes: MutableList<Asistente>) {

    val nombreValue = remember { mutableStateOf("") }
    val apellidoValue = remember { mutableStateOf("") }
    val fechaInscripcionValue = remember { mutableStateOf("") }
    val tipoSangreValue = remember { mutableStateOf("") }
    val telefonoValue = remember { mutableStateOf("") }
    val correoValue = remember { mutableStateOf("") }
    val montoPagadoValue = remember { mutableStateOf("") }
